---
title: Statistical-day2
date: 2019-05-11 19:52:00
tags: [统计基础,任务打卡]
categories: 统计学知识
mathjax: true
---
...
大数定律简单地说，就是当样本量足够大时，样本均值会趋近总体期望值
...
实际上就是概率分布函数，它就是概率函数取值的累加结果！所以它又叫累积概率函数！其实，我觉得叫它累积概率函数还更好理解！！**概率函数和概率分布函数就像是一个硬币的两面，它们都只是描述概率的不同手段！**
...
若随机变量服从一个数学期望为μ、方差为$\sigma^2$ 的正态分布，记为$X\sim{N(\mu，\sigma^2)}$。其概率密度函数为：
$$
